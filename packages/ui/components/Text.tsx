...
const textVariants = cva("", {
  variants: {
    variant: {
      ...
      // --font-size-xxl (32px), --color-text-primary (#212529)
      heading_xl:
      ...
      // --font-size-sxml, --color-form-label (#646f7c)
      unit_lg:
        "text-[length:var(--font-size-sxml)] font-semibold text-text-form-label",
      ...
      // --font-size-sm (14px), --color-text-secondary (#6c757d)
      caption:
    ...
    color: {
      ...
      // --color-positive (#dc3545)
      positive: "text-positive",
      // --color-negative (#0d6efd)
      ...
      // --color-text-primary-link-hover (#36414c)
      link_hover: "text-text-primary-link-hover",
      // --color-text-primary-link (#8899aa)
