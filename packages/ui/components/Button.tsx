...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-radius-sm font-medium text-[length:var(--font-size-md)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transition-all duration-300",
  {
    variants: {
      variant: {
        primary:
